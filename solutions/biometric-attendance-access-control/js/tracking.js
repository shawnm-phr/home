...
/* tracking - page-specific JS (currently no interactive behavior needed) */
(function(){
  var scope = document.querySelector('.tk-scope');
  if(!scope) return; // guard: element absent on non-tracking pages
}());
